...
// Procesamiento del formulario para añadir un libro
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    // Procesar subida de archivo (novela)
    $archivo = $_FILES['archivo']['name'];
    $archivo_temp = $_FILES['archivo']['tmp_name'];
    $archivo_path = 'uploads/' . $archivo;

    // Mover archivo a la carpeta de subidas
    move_uploaded_file($archivo_temp, $archivo_path);

    // Ejecutar la inserción en la base de datos
    $sql = "INSERT INTO libros (titulo, descripcion, imagen, archivo) VALUES ('$titulo', '$descripcion', '$imagen', '$archivo')";
...
<head>
    ...
    <title>Libros - Libros y Galería de Arte</title>
    <style>
        body {
        ...
        <div class="main-content">
            ...
            <section>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <label for="imagen">Subir Imagen (Portada):</label><br>
                    <input type="file" id="imagen" name="imagen" accept="image/*"><br><br>
                    <label for="archivo">Cargar Archivo (Novela):</label><br>
